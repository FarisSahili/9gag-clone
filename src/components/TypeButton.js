...
return (
    <div className='TagCont'>
        ...
        <button className="Tag8" type="button"><a href>house of the dragon</a></button>
        <button className="Tag9" type="button"><a href>chainsaw man</a></button>        
        <button className="Tag10" type="button"><a href>latest news</a></button>
        <br/>
        <button className="Tag11" type="button"><a href>most commented</a></button>
        <button className="Tag12" type="button"><a href>weekly highlights</a></button>
    </div>
);
