...
return (
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="row">
                                ...
                                <button className="ButLogIn" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Already a member? Log in</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body Second">
                            <div className="bodyBut">
                                <button className="ButFacebook"> <a className="facebook" href="https://www.facebook.com/" > <img className="facebook1" src={face1}  alt=""/> Continue with Facebook</a></button>
                                <button className="ButGoogle"> <a className="Google" href="https://www.google.de/" > <img className = "google1" src={google1}  alt=""/> Continue with Google </a></button>
                                <button className="ButApple"> <a className="Apple" href > <img className = "apple1" src={Apple1}  alt=""/> Continue with Apple </a></button>
                            </div>
                            <div className="P-Or" >or</div>
                                ...
                                <button className="Forgot" data-bs-target="#exampleModalToggle3" data-bs-toggle="modal">Forgot Password ?</button>
                            </div>
                    </div>
                </div>
            </div>
        ...
        <div className="modal fade" id="exampleModalToggle3" aria-hidden="true" aria-labelledby="exampleModalToggleLabel3" tabindex="-1">
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <button className="LiftAroww"   data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"> <img className = "LiftAroww" src={LiftArow}  alt=""/> </button>
