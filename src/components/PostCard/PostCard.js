      ...
      <div className="gagger-part">
        ...
        <div className="button-card">
          <div className="vote-button">
            <a className="button-vote">
              <img src={voteup} alt="this is vote up icon" />
              {props.up}k
            </a>
            <a className="button-vote">
              <img src={votedown} alt="this is vote down icon " /> {props.down}
            </a>
            <a className="button-vote">
              <img src={CommitIcon} alt="this is commit icon " />
              90
            </a>
          </div>
          ...
          <div className="share-buttons">
            <a className="share-icon">
              <img src={WhatsAppIcon} alt="this is WhatsAppIcon" />
            </a>

            <a className="share-icon">
              <img src={MessangerIcon} alt="this is MessangerIcon " />
            </a>
            <div class="dropdown">
              <button
                className="dropdown"
              ...
              <ul className="dropdown-menu">
                <li>
                  <a className="dropdown-item">
                    <img
                      className="dropdown-share-icon"
                      src={Link}
                      alt="this is Copylink Icon"
                    />
                    Copy Link
                  </a>
                </li>
